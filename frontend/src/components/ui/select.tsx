  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      <button
        ...
        className={`w-full px-3 py-1.5 rounded-lg border border-line bg-white text-sm text-left focus:outline-none focus:ring-2 focus:ring-teal/20 focus:ring-offset-0 focus:border-teal/40 transition-all flex items-center justify-between ${selected ? 'text-ink' : 'text-muted/50'}`}
      >
