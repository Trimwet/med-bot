      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-gray-400">May 25 - May 31, 2026</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 pt-4 border-t border-gray-100">
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Top Symptoms Reported</h4>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-gray-400">May 1 - May 31, 2026</p>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 bg-[#073B4C] text-white rounded-lg text-sm font-semibold hover:bg-[#0A202A] transition-colors">
            <Download className="w-4 h-4" />
            <span className="hidden sm:inline">Download Report</span>
        ...
        <div className="pt-4 border-t border-gray-100">
          <h4 className="text-sm font-semibold text-gray-700 mb-2">Insights & Trends</h4>
          <div className="space-y-2">
            <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-r-lg">
              <p className="text-sm font-medium text-gray-700">Highest growth in 6 months</p>
              <p className="text-xs text-gray-500">The 18% increase in assessments is the highest recorded growth since November 2025.</p>
            </div>
            <div className="bg-green-50 border-l-4 border-green-400 p-3 rounded-r-lg">
              <p className="text-sm font-medium text-gray-700">Efficiency Peak</p>
              <p className="text-xs text-gray-500">Referral processing time dropped by 24% this month due to new AI sorting algorithms.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-gray-400">Apr 1 - Jun 30, 2026</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 pt-4 border-t border-gray-100">
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Quarterly Summary</h4>
            <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Quarterly Top Symptoms</h4>
            <div className="space-y-2">
              {yearlySymptoms.map((s) => (
                <div key={s.name}>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">{s.name}</span>
                    <span className="text-gray-500">{s.count.toLocaleString()} ({s.percent}%)</span>
                  </div>
                  <div className="w-full h-1.5 bg-gray-100 rounded-full mt-1">
