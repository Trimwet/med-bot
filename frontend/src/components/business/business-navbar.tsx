...
export const BusinessNavbar = ({ onMenuClick }: BusinessNavbarProps) => {
  ...
  return (
    <header className="h-16 bg-white dark:bg-[#0f1117] border-b border-gray-200 dark:border-[#1e2028] flex items-center justify-between px-4 sm:px-6 sticky top-0 z-10 transition-colors">
      <div className="flex items-center gap-3">
        <button
          onClick={onMenuClick}
          className="lg:hidden p-2 text-gray-500 dark:text-[#6b7080] hover:bg-gray-100 dark:hover:bg-[#1a1d25] rounded-lg"
        >
