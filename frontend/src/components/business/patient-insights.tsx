  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Patient Insights</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-[10px] text-gray-400 mt-1 uppercase">{stat.subtitle}</p>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* Risk Categories */}
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h3 className="font-semibold text-gray-900 mb-4">Risk Categories</h3>
          <div className="flex items-center justify-center mb-4">
            <div className="relative w-40 h-40">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-2xl font-bold text-gray-900">3.9k</span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button className="flex items-center gap-3 px-4 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <div className="w-8 h-8 bg-red-50 rounded-lg flex items-center justify-center">
                <FileText className="w-4 h-4 text-red-500" />
              </div>
              <div className="text-left">
                <p className="text-sm font-medium text-gray-700">Download PDF Report</p>
                <p className="text-[10px] text-gray-400">Q4 2025 Assessment Data, 4.2MB</p>
              </div>
            </button>
            <button className="flex items-center gap-3 px-4 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="text-sm font-medium text-gray-700">Download Excel Report</p>
                <p className="text-[10px] text-gray-400">Raw data & metrics spreadsheet</p>
              </div>
            </button>
          </div>
        </div>
