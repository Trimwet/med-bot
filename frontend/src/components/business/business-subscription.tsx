    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <button className="w-full py-2.5 border border-gray-300 rounded-lg text-sm font-semibold text-gray-500 cursor-not-allowed">
            Current Plan
          </button>
        </div>

        {/* Premium Plan */}
        <div className="bg-white rounded-xl border-2 border-[#073B4C] p-6 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl border border-gray-200 p-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">Enjoying MedBot? Upgrade to Premium for advanced features and priority support.</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-400 uppercase font-semibold">Plan Status</p>
              <p className="text-lg font-bold text-gray-900 mt-1">No active renewal</p>
              <p className="text-xs text-gray-500 mt-0.5">Upgrade to unlock full features</p>
            </div>
            <span className="px-3 py-1 bg-gray-100 text-gray-600 text-xs font-semibold rounded-full">FREE</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        ...
        <div className="hidden sm:grid grid-cols-[1.2fr_1fr_1fr_0.8fr_1fr] gap-4 px-5 py-3 border-b border-gray-100 text-xs font-semibold text-gray-400 uppercase tracking-wider">
          <span>Date</span>
          <span>Plan</span>
          <span>Amount</span>
          <span>Status</span>
        ...
        <div className="text-center py-3 border-t border-gray-100">
          <button className="text-sm text-gray-500 hover:text-gray-700">View Older Payments</button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        ...
        <div className="hidden sm:grid grid-cols-[1.2fr_1fr_1fr_1fr_0.8fr_0.8fr] gap-4 px-5 py-3 border-b border-gray-100 text-xs font-semibold text-gray-400 uppercase tracking-wider">
          <span>Invoice #</span>
          <span>Date</span>
          <span>Plan</span>
          <span>Amount</span>
        ...
        <div className="divide-y divide-gray-100">
          {invoices.map((inv, i) => (
            <div key={i} className="grid grid-cols-1 sm:grid-cols-[1.2fr_1fr_1fr_1fr_0.8fr_0.8fr] gap-2 sm:gap-4 px-5 py-4 items-center">
              ...
              <span className="text-sm text-gray-600">{inv.plan}</span>
              ...
              <button className="p-2 text-gray-400 hover:text-gray-600 self-start sm:self-center">
